	...
	public static void handleWelcomeScreenInput() {
		...
		do {
			try {
				...
				switch (input) {
				case 1:
					Operations.displayAllFiles("Folder");
					break;
				case 2:
					Display.handleFileMenuOptions();
					break;
				case 3:
		...
		do {
			try {
				...
				case 2:
					...
					Operations.createMainFolderIfNotPresent("Folder");
					List<String> filesToDelete = Operations.displayFileLocations(fileToDelete, "Folder");
					...
					if (idx != 0) {
						Operations.deleteFile(filesToDelete.get(idx - 1));
					} else {
				...
				case 3:
					...
					Operations.createMainFolderIfNotPresent("Folder");
					Operations.displayFileLocations(fileName, "Folder");
